package com.example.mybatisplusbatch.generator;
...
public class MysqlGenerator {
    ...
    private static final String AUTHOR_NAME = "chenjing";
    ...
    public static void main(String[] args) {
        ...
        String outputDirTemplate = "/%s/src/main/java";
        gc.setOutputDir(projectPath + String.format(outputDirTemplate, PROJECT_NAME));
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                String mapperPathTemplate = "/%s/src/main/resources/mapper/";
                return projectPath + String.format(mapperPathTemplate, PROJECT_NAME) + pc.getModuleName()
        ...
        strategy.setSuperEntityClass(ROOT_PACKAGE + ".entity.BaseEntity");
